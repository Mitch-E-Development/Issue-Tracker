...
//         const updatedIssueData = req.body; // Get the updated issue data from request body
//         const newNote = req.body.newNote; // Get the new note from request body
...
//             issue.notes.push(newNote); // Push the new note onto the existing notes array
//         }
...
//         issue.severity = updatedIssueData.severity || issue.severity;
//         issue.description = updatedIssueData.description || issue.description;
//         // issue.notes = issue.notes.push(...updatedIssueData.notes) || issue.notes;
        

//         // // Append new notes to the existing notes array
//         if (issue.notes === null) {
//             issue.notes = newNotes
//         } else {
//             issue.notes.push(newNotes);
//         }
...
//     try {
//         const { id } = req.params; // Get the id from request parameters
//         const updatedNotes = [req.body.notes]; // Get the updated notes array from request body
...
//         // Append the new operations to the existing operations array
//         issue.notes.push(...updatedNotes);

//         // Save the updated issue with the new operations
//         await issue.save();

//         // Issue updated successfully
//         return res.status(200).json({ message: 'Notes appended successfully.' });
//     } catch (error) {
//         console.log(error.message);
//         res.status(500).send({ message: error.message });
//     }
